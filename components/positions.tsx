    ...
    <div className="bg-[#f5f5f5] py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-[#003366] mb-4">Positions</h2>
          ...
          >
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 relative h-[400px]">
                <Image
                  src={positions[currentSlide].image}
                  alt={positions[currentSlide].name}
                  fill
              ...
              <div className="md:w-1/2 p-8 flex flex-col justify-center bg-white">
                <div className="border-l-4 border-[#003366] pl-6">
                  <h3 className="text-3xl font-bold text-[#003366] mb-4">
                    {positions[currentSlide].name}
                  </h3>
                  <p className="text-xl text-gray-600 mb-4">
                    {positions[currentSlide].achievement}
                  </p>
                  <p className="text-2xl font-semibold text-[#003366] mb-2">
                    Marks: {positions[currentSlide].marks}
                  </p>
                  <p className="text-lg text-gray-500">
                    Year: {positions[currentSlide].year}
                  </p>
                </div>
              </div>
            </div>
