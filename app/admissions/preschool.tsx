    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <div className="relative h-[35vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/journey1.jpg" // Use a relevant image for preschool
            alt="Preschool Banner"
            fill
      ...
      <section className="py-16 px-4">
        ...
        >
          <p className="text-lg text-gray-300 mb-12">
            {/* Add your content here for preschool admissions */}
            Welcome to the Preschool Admissions page. Here you will find all the necessary information to enroll your child in our preschool program.
          </p>
        </motion.div>
      </section>
    </div>
