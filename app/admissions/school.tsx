    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <div className="relative h-[35vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/journey1.jpg" // Use a relevant image for school
            alt="School Banner"
            fill
      ...
      <section className="py-16 px-4">
        ...
        >
          <p className="text-lg text-gray-300 mb-12">
            {/* Add your content here for school admissions */}
            Welcome to the School Admissions page. Here you will find all the necessary information to enroll your child in our school program.
          </p>
        </motion.div>
      </section>
    </div>
